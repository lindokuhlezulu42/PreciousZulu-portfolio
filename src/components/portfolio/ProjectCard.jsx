...
export default function ProjectCard({ project, index }) {
  return (
    <motion.article
      ...
      className="bg-card border border-border rounded-2xl p-6 hover:border-primary/30 transition-all duration-300 group flex flex-col"
    >
      ...
      <div className="flex gap-3">
        {project.github && (
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-secondary text-foreground text-sm font-medium hover:bg-primary/10 hover:text-primary transition-all"
          >
            <GithubIcon />
            View Code
          </a>
