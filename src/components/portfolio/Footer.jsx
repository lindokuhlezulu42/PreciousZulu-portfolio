        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
              <span className="text-primary-foreground font-heading font-bold text-sm">PZ</span>
            </div>
            <span className="font-heading font-semibold text-foreground">Precious Zulu</span>
          </div>
          ...
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Precious Zulu. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
